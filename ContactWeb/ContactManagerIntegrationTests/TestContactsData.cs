...
namespace ContactManagerIntegrationTests
{
    public class TestContactsData
    {
        DbContextOptions<ContactManagerDbContext> _options;
        ...
        {
            _options = new DbContextOptionsBuilder<ContactManagerDbContext>()
                            .UseInMemoryDatabase(databaseName: "ContactManagerContactsTests")
                            .Options;
        }

        public void BuildDefaults()
        {
            using (var context = new ContactManagerDbContext(_options))
            {
